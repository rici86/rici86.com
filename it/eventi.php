...
<head>
    ...
    <title>Organizzazione eventi | Rici86: Coder, Crafter, Creative e anche un po' Nerd </title>
...
<body>
    <div id="main-container">
        ...
        <a href="../en/events.php" title="English" class="lang-switcher">
            ...
            <section class="main-row main-row-invert" aria-labelledby="#secton-title-2">
                ...
                <div class="card">
                    ...
                    <p>
                        ...
                        <br>Una grande ricerca storica alle spalle consente ai Ghost Tour una grande accuratezza storica, che fa da sfondo a questi percorsi nel mistero, ricchi di emozioni.
                    </p>
                    <p>
                        ...
                        <br>Ad ogni nuova edizione, rinnovavo la mia disponibilità. Ho affinato le mie abilità recitative per dare il meglio: lavorare con attori professionisti mi ha insegnato molto, ed è stato veramente lusinghiero potermi confrontare con loro. 
                    </p>
                    <p>
            ...
            <section class="main-row" aria-labelledby="#secton-title-3">
                <div class="card">
                    <div class="header-flex-between">
                        ...
                        <a href="misteri-del-castello.php" class="button button-main">Scopri di più</a>
                    </div>
                    <p>
